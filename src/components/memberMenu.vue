<template>
  <div class="menu">
    <div class="menu-list">
      ...
      <div class="list-item" @click="goRouter('estimate')">
        <i class="icon iconfont icon-coordinates_fill" style="color: #87c38f"></i>
        <span>能力评估</span>
      </div>
      <div class="list-item" @click="goRouter('articles')">
        <i class="icon iconfont icon-xuexi" style="color: #87c38f"></i>
        <span>备考文库</span>
      </div>
      <div class="list-item" @click="goRouter('noteList')">
        <i class="icon iconfont icon-baoming" style="color: #87c38f"></i>
        <span>我的笔记</span>
      </div>
