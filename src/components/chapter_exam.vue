<template>
  <div class="exam">
    ...
    <div class="head-control-tools">
      <span @click="toggleCover"> <i class="icon iconfont icon-yewanmoshi"></i>白天/夜间</span>
      <span @click="notes"> <i class="icon iconfont icon-baoming"></i>笔记</span>
    </div>
    ...
    <!--笔记-->
    <note v-bind:number="curr.number"></note>
  </div>
</template>
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .head-control-tools
    ...
    align-items center
    box-sizing border-box
    background rgba(7,17,27,0.1) // #fbf9fe
    color #333
    font-size 14px
    span
      height 100%
